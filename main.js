const data = [
  ...
  },
  {
    type: "Aesthetic Symbols",
    theme: "Celestial",
    tags: ["celestial", "space"],
    items: ["☾", "☽", "☀", "☼", "✶", "✷", "✵", "✦", "✧", "✩", "✪", "✫", "✬", "✭", "✮", "✯", "✰", "⛧", "🜚", "🜛"]
  },
  {
    type: "Aesthetic Symbols",
    theme: "Vintage Marks",
    tags: ["vintage", "ornament"],
    items: ["❦", "❧", "❃", "❊", "❖", "✣", "✤", "✥", "✦", "✧", "✩", "✪", "✫", "✬", "✭", "❈", "✺", "✵", "✶", "✷"]
  },
  {
    type: "Aesthetic Symbols",
...
const i18n = {
  en: {
    ...
    seo_title: "Emoji, Kaomoji, and Symbol Library",
    seo_p1: "Special Emoji Studio is a curated collection of kaomoji, aesthetic symbols, ASCII art, and Emoji Kitchen mashups. Browse by category, filter by theme, and copy in one click for captions, bios, chats, and design.",
    seo_p2: "Find cute, cool, or minimal styles fast with organized lists and Unicode blocks. Use this library to decorate social posts, add separators, or build a consistent tone across your messages.",
    all: "All",
  ...
  ko: {
    ...
    seo_title: "이모지, 카모지, 심볼 라이브러리",
    seo_p1: "스페셜 이모지 스튜디오는 카모지, 에스테틱 심볼, ASCII 아트, 이모지 키친을 모은 큐레이션 라이브러리예요. 카테고리와 테마로 빠르게 찾고 클릭 한 번에 복사할 수 있어요.",
    seo_p2: "귀엽거나 미니멀한 스타일을 정리된 목록과 유니코드 블록으로 바로 찾을 수 있어요. 캡션과 프로필, 메시지에 분위기를 더해보세요.",
    all: "전체",
    recent: "최근 복사됨",
  ...
  ja: {
    ...
    seo_title: "絵文字・カオモジ・記号ライブラリ",
    seo_p1: "Special Emoji Studioは、カオモジ・美学記号・ASCIIアート・絵文字キッチンを集めたライブラリです。カテゴリとテーマで探して、クリック一つでコピーできます。",
    seo_p2: "かわいい・クール・ミニマルなスタイルを、整理されたリストとUnicodeブロックから素早く見つけられます。投稿やプロフィールの装飾にどうぞ。",
    all: "すべて",
    recent: "最近コピー",
  ...
  zh: {
    ...
    seo_title: "表情、颜文字与符号库",
    seo_p1: "Special Emoji Studio 汇集颜文字、美学符号、ASCII 艺术与表情厨房合成图。按分类与主题筛选，一键复制用于简介、聊天或设计。",
    seo_p2: "用整理好的列表与 Unicode 区块快速找到可爱、简约或酷炫风格，为你的内容添加统一氛围。",
    all: "全部",
    recent: "最近复制",
    click_to_copy: "点击复制",
    copied: "已复制！",
  ...
  es: {
    ...
    seo_title: "Biblioteca de emojis, kaomoji y símbolos",
    seo_p1: "Special Emoji Studio reúne kaomoji, símbolos estéticos, arte ASCII y mezclas de Emoji Kitchen. Busca por categoría y tema, y copia al instante para bios, chats o diseño.",
    seo_p2: "Encuentra estilos lindos, minimalistas o cool con listas ordenadas y bloques Unicode. Úsalo para dar coherencia a tus publicaciones y mensajes.",
    all: "Todos",
...
const i18nThemeMap = {
  ko: {
    ...
    "Aesthetic Symbols": {
      ...
      Celestial: "천체",
      "Vintage Marks": "빈티지 장식",
      "Soft Arrows": "부드러운 화살표",
      "Tiny Shapes": "작은 도형"
    },
    "ASCII Art": {
      Cat: "고양이",
  ...
  es: {
    ...
    "Aesthetic Symbols": {
      ...
      Celestial: "Celestial",
      "Vintage Marks": "Marcas vintage",
      "Soft Arrows": "Flechas suaves",
      "Tiny Shapes": "Formas pequeñas"
    },
    "ASCII Art": {
      Cat: "Gato",
      Bear: "Oso",
